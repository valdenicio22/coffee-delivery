...
export function ConfirmeOrderSection() {
  return (
    <div>
      ...
      <div className="flex flex-col p-10 bg-base-card rounded-tl-md rounded-tr-[44px] rounded-br-md rounded-bl-[44px]">
        ...
        <button className="w-full flex items-center justify-center bg-brand-yellow text-base-white text-button-lg font-bold rounded-md uppercase mt-6 py-3 px-2">
          Confirmar Pedido
        </button>
      </div>
    </div>
